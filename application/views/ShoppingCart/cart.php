<!-- This is the cart part of the view on the website for the Shopping Cart Tutorial. The tutorial can be
...
<?php echo form_open('ShoppingCartCon/Cart/update_cart'); ?>
...
<p><?php echo form_submit('', 'Update your Cart'); echo anchor('ShoppingCartCon/Cart/empty_cart', 'Empty Cart', 'class="empty"');?></p>
